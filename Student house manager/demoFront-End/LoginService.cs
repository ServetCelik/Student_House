...
namespace demoFront_End
{
    public class LoginService
    {
        ...
        public void AddDummyUser()
        {
            ...
            Login.lUser.Add(new User("servet", "123", "servet", usertype.admin));
            Login.lUser.Add(new User("cynthia", "123", "cynthia", usertype.admin));
            Login.lUser.Add(new User("edvinas", "123", "edvinas", usertype.admin));
            Login.lUser.Add(new User("regular", "123", "regular", usertype.tenant));
            Login.lUser.Add(new User("regular1", "123", "regular", usertype.tenant));
            Login.lUser.Add(new User("regular2", "123", "regular", usertype.tenant));
            Login.lUser.Add(new User("regular3", "123", "regular", usertype.tenant));
            Login.lUser.Add(new User("regular4", "123", "regular", usertype.tenant));
            Login.lUser.Add(new User("regular5", "123", "regular", usertype.tenant));
            Login.lUser.Add(new User("regular6", "123", "regular", usertype.tenant));
            Login.lUser.Add(new User("regular7", "123", "regular", usertype.tenant));
            Login.lUser.Add(new User("regular8", "123", "regular", usertype.tenant));
        }
